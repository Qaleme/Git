...
class ParametersController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Parameters->save($parameter)) {
                $this->Flash->success('The parameter has been saved.');
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error('The parameter could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Parameters->delete($parameter)) {
            $this->Flash->success('The parameter has been deleted.');
        } else {
            $this->Flash->error('The parameter could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
